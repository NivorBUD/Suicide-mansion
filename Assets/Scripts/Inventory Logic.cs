...
public class InventoryLogic : MonoBehaviour
{
    ...
    {
        GameObject.FindWithTag("Player").GetComponent<Hero>().AddToInventory(InventoryObject);
    ...
    {
        GameObject.FindWithTag("Player").GetComponent<Hero>().DelFromInventory(InventoryObject);
